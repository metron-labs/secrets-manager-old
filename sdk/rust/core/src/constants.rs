...
pub fn get_keeper_servers() -> HashMap<&'static str, &'static str> {
    // Define the static array with your key-value pairs
    let data = [
...
pub fn get_keeper_public_keys() -> HashMap<String, String> {
    // Define the static array with key-value pairs
    let data = [
